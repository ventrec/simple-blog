...
<div id="content">
    ...
    {{ Form::open(array('route' => array('home.store'), 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'patch')) }}
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            {{ Form::textarea('text', null, array('class' => 'form-control', 'id' => 'InputText', 'placeholder' => 'Body')) }}
